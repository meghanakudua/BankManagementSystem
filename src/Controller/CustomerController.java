...
public class CustomerController {
    ...
    /*public static boolean withdrawAmount(String accountNumber, double amount) {
    ...
    /*public static boolean withdrawAmount(String accountNumber, double amount) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            // Get customer's balance and branch
